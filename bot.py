# here the bot should choose one movement
# from all the ones that Board class creates
...
class Bot():
    ...
    def chose_movement(self):
        max = -inf
        # list_of_best_moves = []
        for _, v1 in self.dic_of_posible_movements.items():
            if max < v1['score']:
                max = v1['score']
                self.best_mov = v1
